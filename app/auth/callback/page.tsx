...
function AuthCallbackContent() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      if (msg) {
        if (
          msg.toLowerCase().includes("confirmation link accepted") &&
          msg.toLowerCase().includes("please proceed")
        ) {
          setStatus("success");
          setMessage(
            "Langkah pertama berhasil! Silakan cek email baru Anda dan klik tautan konfirmasi untuk menyelesaikan perubahan."
          );
          return;
        }
      }
